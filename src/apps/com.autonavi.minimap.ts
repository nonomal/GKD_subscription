      ...
      rules: [
        {
          ...
          action: 'clickCenter',
          matches:
            'View[text!="" && text!=null] <(1,2) ViewGroup[childCount=2 || childCount=3] <<n ViewGroup >(1,2) [text!="查看更多"] + @ViewGroup[index!=0][childCount=1][visibleToUser=true][clickable=true][height>=60] > ImageView',
          exampleUrls: [
