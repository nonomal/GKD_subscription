...
export default defineAppConfig({
  ...
  groups: [
      ...
      rules: [
        {
          ...
          excludeActivityIds:
            'com.netease.cloudmusic.music.biz.comment.activity.CommentActivity', // 排除评论区，避免节点被遮罩时误触，评论区广告规则见 groups key2
      ...
      rules: [
        ...
        },
        {
          ...
          snapshotUrls: [
            ...
            'https://i.gkd.li/i/14070500', // 通过广告下方评论 visibleToUser=true 防止在此页面误触
          ],
        },
      ],
    },
    {
      ...
      quickFind: true,
      activityIds: 'com.netease.cloudmusic.activity.MainActivity',
      rules: '@ImageView + ViewGroup > TextView[text="VIP歌曲免费听 30 分钟"]',
      ...
      rules: [
        ...
        },
        {
          ...
          activityIds:
            'com.netease.cloudmusic.music.biz.rn.activity.MainProcessLayerReactNativeActivity',
          matches:
            '@ViewGroup[clickable=true][childCount=1] -(3,4) ViewGroup[childCount=19] > [text="黑胶 VIP 连续包季"]',
          snapshotUrls: [
    ...
    },
    {
      ...
      activityIds: 'com.netease.cloudmusic.activity.MainActivity',
      matchTime: 10000,
      rules: '@ImageView + ViewGroup > [text="VIP歌曲免费听 30 分钟"]',
      ...
      rules: [
        {
          ...
          name: '点击[关闭]',
          matches:
            // 通过广告下方评论 visibleToUser=true 防止误触
